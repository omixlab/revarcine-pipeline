...
def run():
    ...
    file_path = arq.get('FILE_SP_GN','file_path')

    # hyperparameters
    SAMPLES_PER_GROUP = int(arq.get('CONSTANTS_SP_GN','SAMPLES_PER_GROUP'))
    MAX_VOCAB_SIZE = int(arq.get('CONSTANTS_SP_GN','MAX_VOCAB_SIZE'))
    SEQUENCE_SIZE = int(arq.get('CONSTANTS_SP_GN','SEQUENCE_SIZE'))
    EMBEDDING_SIZE = int(arq.get('CONSTANTS_SP_GN','EMBEDDING_SIZE'))
